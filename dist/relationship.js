...
const relationships = require(_path2.default.resolve(process.cwd(), 'dist', 'server', 'models', 'relationships'));

class SequelizeRelationship extends _base2.default {
  setup() {
    var _this = this;
    ...
    return _asyncToGenerator(function* () {
      ...
      relationships.relationships(_this.app);
      // All relationships should locate in server/models/relationships.js

      if (config.sync) {
        yield _this.app.sequelize.sync(config.sync);
      }
    })();
  }
}
